...
const PixButton = class {
  ...
  render() {
    let template;
    if (this.getIsLoading()) {
      template = (index.h(index.Fragment, null, index.h("div", { class: "loader loader--blue" }, index.h("div", { class: "bounce1" }), index.h("div", { class: "bounce2" }), index.h("div", { class: "bounce3" })), index.h("span", { class: "loader__not-visible-text" }, index.h("slot", { name: "text" }))));
    }
    else {
      template = index.h(index.Fragment, null, index.h("slot", { name: "text" }));
    }
    return (index.h("button", { onClick: this._triggerAction.bind(this), type: this.type, class: this.updateClassNames(), disabled: this.getIsDisabled(), "aria-disabled": this.getIsDisabled() }, template));
  }
